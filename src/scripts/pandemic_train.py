...
def init(args):
    ...
    done_fn = ps.env.DoneFunctionFactory.default(ps.env.DoneFunctionType.TIME_LIMIT, horizon=193 if False else 192) # changed from cfg.four_start
...
def main():
    wandb.login(key='e80b79187a13507c5f50756b3dc80ce702cf6f8b')
