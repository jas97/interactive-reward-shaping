...
source_path = '../reward-misspecification/scripts/'  # the path to the location of the folder 'bgp' which contains the source code
print(base_name)
...
seed_options = [np.random.randint(1, 2**31)]
...
rnn_layers = int(sys.argv[3])
ground_truth_network_size = 256
loss_function = nn.SmoothL1Loss
reward_fun = sys.argv[4] #'magni_bg'
true_reward_fun = sys.argv[5] #'magni_bg_insulin'
use_only_during_day = False
noise_scale = float(sys.argv[7])
